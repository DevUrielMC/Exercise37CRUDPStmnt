...
public class CreateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		myEmployee.setAgeEmployee(Integer.parseInt("txtAgeEmployee"));
		myEmployee.setAddressEmployee(request.getParameter("txtAddressEmployee"));
		myEmployee.setSalaryEmployee(Double.parseDouble("txtSalaryEmployee"));
		...
		try {
			...
			//abrimos la conexion
			DriverManager.getConnection(urlServer, userName, password);
